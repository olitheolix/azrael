...
from azBullet import DefaultRigidBodyState, Transform
...
mass = 0
groundRigidBodyState = DefaultRigidBodyState(
...
fallRigidBodyState = DefaultRigidBodyState(
...
for ii in range(10):
    ...
    ms = fallRigidBody.getRigidBodyState()
